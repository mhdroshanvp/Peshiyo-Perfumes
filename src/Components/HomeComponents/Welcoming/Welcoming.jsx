    ...
    <>
      ...
      <div className='welcome-collapse'>
        ...
        <div className='collapse-section'>
          ...
          {openSection === 2 && (
            <div className='collapse-content'>
              <p>A fragrance is a personal statement—it speaks before you do. The right perfume complements your style, enhances your presence, and creates a unique aura around you. Whether you love fresh and citrusy notes for daytime wear or rich, sensual aromas for special occasions, Peshiyo offers a collection of expertly crafted perfumes to suit every mood and moment.
              With high-quality ingredients and long-lasting formulas, we ensure every drop of fragrance delivers an experience of elegance and charm—at a price that fits your lifestyle.</p>
            </div>
          )}
        </div>
        ...
        <div className='collapse-section'>
          ...
          {openSection === 3 && (
            <div className='collapse-content'>
              <p>Fragrance is more than a scent—it’s an identity. It evokes emotions, sparks memories, and leaves a lasting impression. At Peshiyo, we blend luxury with affordability to craft signature perfumes that define you. From floral to woody to oriental, each bottle is designed to make you feel confident, refined, and unforgettable.</p>
            </div>
          )}
        </div>
      </div>
